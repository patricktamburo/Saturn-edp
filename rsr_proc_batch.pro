...
cors = '125'         ;e.g., 207. No zero in front. 125 is for S14N SX14
band = 'X'          ;i.e., X, S, or K. Must be capitalized.
rsrfilesuffix = 's14sroi2005248_1323nnnx14rd.2a2' ;e.g., s36saoe2007353_0524nnns63rd.1b2

datapath = rootdatapath+'Cassini_Ionosphere/Data/cors_0'+cors+'/'
outputpath = rootoutputpath+'Cassini_Ionosphere/Output/'+body+'/cors_0'+cors+'/'
