...
if strmatch(bands, 'S*') then restore, rootpath+body+'\cors_'+scors+'\'+sproductid+'\full_output\simpleocc_output.sav',/verbose;
;if strmatch(bands, 'X*') then restore, rootpath+body+'/cors_'+xcors+'/'+xproductid+'/full_output/simpleocc_output.sav'
if strmatch(bands, 'X*') then restore, rootpath+body+'\cors_'+xcors+'\'+xproductid+'\full_output\simpleocc_output.sav',/verbose
